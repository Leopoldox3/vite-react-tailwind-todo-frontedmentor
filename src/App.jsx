    ...
    return (
        <div className="min-h-screen bg-gray-200 bg-[url('./assets/images/bg-mobile-light.jpg')] bg-contain bg-no-repeat">
            <header className="container mx-auto px-4 pt-8">
                ...
                <form className="mt-7 flex items-center gap-4 overflow-hidden rounded-md bg-white px-4 py-4">
                    <span className="inline-block h-5 w-5 rounded-full border-2"></span>
                    <input
                        className="w-full font-light text-gray-400 outline-none"
                        type="text"
                        placeholder="Create a new todo..."
                    />
                </form>
            </header>
            <main className="container m-7 mx-auto px-4">
                ...
                <div className="rounded-md bg-white [&>article]:p-4">
                    ...
                    <section className="flex justify-between px-4 py-4">
                        <spam className="text-gray-400">5 items left</spam>
